...
# Question 3 - Programmatically determine whether 42 lies between 10 and 100, inclusive. 
...
# Question 4 - Given a list of numbers [1, 2, 3, 4, 5], 
...
# Question 6 - Back in the stone age (before CSS), we used spaces to align things on the screen. 
